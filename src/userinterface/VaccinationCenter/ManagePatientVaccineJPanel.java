...
public class ManagePatientVaccineJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblManageInventory, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 510, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 692, 181));
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 250, -1, -1));

        lblBatch.setFont(new java.awt.Font("Helvetica Neue", 1, 13)); // NOI18N
        lblBatch.setText("Staff ID:");
        add(lblBatch, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, -1, -1));

        txtStaffID.setEditable(false);
        txtStaffID.setBackground(new java.awt.Color(255, 255, 255));
        add(txtStaffID, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, 200, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       try{
        for(WorkRequest wr : enterprise.getWorkQueue().getWorkRequestList())  {
           ...
           for(Patient p: vp.getNonVaccinationPatient()){
